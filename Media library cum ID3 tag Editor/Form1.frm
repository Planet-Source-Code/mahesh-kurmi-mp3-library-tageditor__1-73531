VERSION 5.00
Object = "{1A7EC5AF-A6DB-4D52-8AE1-8DE982A74E1E}#1.0#0"; "RMListView.ocx"
Begin VB.Form Form1 
   Caption         =   "Form1"
   ClientHeight    =   4350
   ClientLeft      =   120
...
Private Sub Form_Load()
    ...
    With ListView1
        ...
        .AddColumn "jjj", "mahesh", TextAlignCenter, 60, False, True
...
Private Sub Form_Resize()
    With ListView1
        ...
        If Me.ScaleHeight - (.Top - 20 + 8) * 2 > 0 Then .Height = Me.ScaleHeight - (.Top - 20 + 8) * 2
    End With
End Sub
